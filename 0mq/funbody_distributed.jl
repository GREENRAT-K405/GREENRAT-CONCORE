# funbody_distributed.jl
# Julia port of funbody_distributed.py
# ZMQ REP server for distributed (cross-machine) deployment.
# Binds on 0.0.0.0 (all interfaces) so remote funcall nodes can connect.
...
# Bind on all interfaces (0.0.0.0) to accept remote connections
