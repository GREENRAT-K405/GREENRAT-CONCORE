...
mkdir F1
copy .\src\funcall.py .\F1\funcall.py
copy .\src\concore.py .\F1\concore.py
copy .\src\concore_base.py .\F1\concore_base.py
copy .\src\funcall.iport .\F1\concore.iport
copy .\src\funcall.oport .\F1\concore.oport
copy  .\src\funcall.dir\*.* .\F1
mkdir F2
copy .\src\funbody.py .\F2\funbody.py
copy .\src\concore.py .\F2\concore.py
copy .\src\concore_base.py .\F2\concore_base.py
copy .\src\funbody.iport .\F2\concore.iport
copy .\src\funbody.oport .\F2\concore.oport
copy  .\src\funbody.dir\*.* .\F2
mkdir U
mkdir Y
mkdir U2
mkdir Y2
