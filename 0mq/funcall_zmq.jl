# funcall_zmq.jl
# Julia port of funcall_zmq.py
# ZMQ REQ client node: reads u from file-port U, sends u_signal to funbody_zmq,
# receives ym_signal, writes ym to file-port Y.
...
init_zmq_port(PORT_NAME_F2_F1, "connect", "tcp://localhost:" * PORT_F2_F1, "REQ")
...
while state.simtime < state.maxtime
    ...
    concore_write(PORT_NAME_F2_F1, "u_signal", u)

    # concore_read strips simtime prefix and updates state.simtime
    received_ym = concore_read(PORT_NAME_F2_F1, "ym_signal", init_simtime_ym_str)
